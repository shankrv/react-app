...
export default function ProjectDetails({ project, tasks, onDeleteProject, onAddTask, onDeleteTask }) {
  const dueDate = new Date(project.dueDate).toLocaleDateString('en-IN', {
    year: 'numeric',
    month: 'short',
    day: 'numeric',
  });
